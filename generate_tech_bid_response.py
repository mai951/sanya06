# -*- coding: utf-8 -*-
"""
Generate a technical bid response document for 三亚06, based on the A7 reference format.
"""
...
def main():
    ...
    difficulties = [
        '工期刚性约束强：总工期仅212天，临街节点仅120天。控制措施：编制分阶段流水施工计划，临街段资源倾斜，采用分段施工+资源前置，关键路径压缩。',
    ...
    # Save the document
    output_path = r'D:\罗\2026\三亚\001\三亚06地块商业改造外装综合幕墙工程_技术标_施工组织设计_响应内容.docx'
